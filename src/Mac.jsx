const Mac = () => {
  return (
    <div className="min-h-screen flex flex-col items-center text-center p-6 space-y-6 bg-custom-gradient">
      ...
      <h3 className=" font-bold text-lg font-light text-gray-600 bg-gradient-to-r from-[#148BF7] via-[#BB62FC] to-[#F3493F] bg-clip-text text-transparent">Built for Apple Intelligence.</h3>
    </div>
  );
};
